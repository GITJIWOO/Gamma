...
import org.game.user.domain.QuesitonSearchCriteria;
...
public interface QuestionMapper {
	...
	public List<QuestionVO> getQuestionListP(@Param("cri")QuesitonSearchCriteria cri, @Param("qwriter")String qwriter);
	// 위 메서드 개수 조회 
	...
	public List<QuestionVO> getQtypeQuestionP(@Param("cri")QuesitonSearchCriteria cri, @Param("qtype")String qtype);
	// 위 메서드 개수 조회 
