...
public class UploadController {
	...
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
		...
		// 저장 경로
		String uploadFolder = "/resources/css/image";
	...
	public ResponseEntity<List<UserAttachVO>> uploadAjaxPost(
											MultipartFile[] uploadFile) {
		
		log.info("ajax post update!");
		
		// 그림 여러개를 받아야 하기 때문에 먼저 ArrayList를 생성
		List<UserAttachVO> list = new ArrayList<>();
		...
		for(MultipartFile multipartFile : uploadFile) {
			...
			UserAttachVO attachDTO = new UserAttachVO();
			...
			uploadFileName = uuuid.toString() + "_" + uploadFileName;
			...
			try {
				...
				attachDTO.setUuuid(uuuid.toString());
		...
		return new ResponseEntity<List<UserAttachVO>>(list, HttpStatus.OK);
	}// uploadAjaxPost
	...
	public ResponseEntity<byte[]> getFile(String fileName){
		...
		File file = new File("/resources/css/image" + fileName);
	...
	public ResponseEntity<String> deleteFile(String fileName, String type){
		...
		try {
			...
			file = new File("/resources/css/image" 
